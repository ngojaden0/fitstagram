            ...
            public void onClick(View view) {
                ...
                if((!TextUtils.isEmpty(description.getText().toString()) || !TextUtils.isEmpty(time.getText().toString())) && (!(file1==null) || !(file2==null) || !(file3==null))) {
                    ...
                    if(choice)
                        ...
                        db.collection("feed").document(Long.toString(post_id)).set(new voting_post(user_id,post_id,description.getText().toString(), true, Integer.parseInt(time.getText().toString()), null));
